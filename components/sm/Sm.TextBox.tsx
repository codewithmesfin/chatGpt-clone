...
export default function SMTextBox({
  onChage,
  onEnter,
  input,
  onRefresh,
    ...
    <div className="stretch mx-2 flex flex-row gap-3 pt-2 last:mb-2 md:last:mb-6 lg:mx-auto lg:max-w-3xl lg:pt-6">
      <div className="relative flex h-full flex-1 md:flex-col">
        <div className="ml-1 mt-1.5 md:w-full md:m-auto md:flex md:mb-2 gap-2 justify-center">
          ...
          <button
            onClick={saveHistory}
            className="btn py-1.5 px-5 text-blue-600 rounded flex justify-center items-center gap-2 btn-neutral border-0 md:border"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
