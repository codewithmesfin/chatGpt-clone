              ...
              <section className="md:w-[30%] h-[100vh] border-r border-gray-300 hidden md:block">
                <div className="w-full">
                  ...
                  <section className="sticky p-5 bg-white bottom-0 w-[100%] right-0 left-0  w-full">
                    <div className="pb-3">
                      <button className="font-semibold text-sm text-red-600 pb-3" onClick={()=>{
                        localStorage.clear()
                        setGroup([])
                  ...
                  >
                    {groups.map((group: any, g: number) => (
                      <div key={g}>
                        {group.is_code}
                        <div>
                          <div className="w-full md:px-10 border-b border-black/10 dark:border-gray-900/50 text-gray-800 dark:text-gray-100 group dark:bg-gray-800">
                            <div className="text-base gap-4 md:gap-6 m-auto md:max-w-2xl lg:max-w-2xl xl:max-w-3xl p-4 md:py-6 md:flex lg:px-0">
                              ...
                              <div className="relative flex w-[calc(100%-50px)] md:flex-col lg:w-[calc(100%-115px)]">
                                <div className="flex flex-grow flex-col gap-3">
                                  <div className="min-h-[20px] capitalize flex flex-col items-start gap-4 whitespace-pre-wrap">
                                    {group.title}
                                  </div>
                                </div>
                          ...
                          <div
                            style={{
                              paddingBottom:
                                g === groups.length - 1 && !item.loading
                                  ? 300
                                  : 5,
                            }}
                            className="w-full  md:px-10 border-b border-black/10 dark:border-gray-900/50 text-gray-800 dark:text-gray-100 group bg-gray-50 dark:bg-[#444654]"
                          >
                            <div className="text-base gap-4 md:gap-6 m-auto md:max-w-2xl lg:max-w-2xl xl:max-w-3xl p-4 md:py-6 md:flex lg:px-0">
                    ...
                    {item.loading && (
                      <div className="p-3  pt-16 pb-[300px]">
                        <h1 className="text-xs text-blue-500 text-center">
                          Wait for a moment ...
                        </h1>
                      </div>
                    )}
