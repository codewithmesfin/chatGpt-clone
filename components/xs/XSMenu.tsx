...
export default function XSMenu(props: any) {
  ...
  return (
    ...
    <Disclosure
      as="nav"
      className="fixed w-full top-0 z-10  border-b border-white/20  pl-1  text-gray-200 sm:pl-3 md:hidden"
    >
      ...
      {({ open }) => (
        <>
          <div className="flex justify-between items-center bg-gray-900">
            <Disclosure.Button
              type="button"
              className="-ml-0.5 -mt-0.5 inline-flex h-10 w-10 items-center justify-center rounded-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white dark:hover:text-white"
            >
              {open ? (
                <XMarkIcon
            ...
            <button   onClick={props.newChat} className="flex-1 text-center text-base font-normal">
              New chat
            </button>
          ...
          <Disclosure.Panel className="sm:hidden bg-gray-900  overflow-y-auto h-screen w-[80%] shadow z-50">
          
            <nav className="flex h-[80%] flex-1 flex-col space-y-1 p-2">
